...
class KnowledgeData {
    ...
    load(dbItems, dbRelationship) {
        for (let row of dbRelationship) {
            let parentId = row['parentId'];
            let childId = row['childId'];
            let parentIndex = this.getIndex(parentId, dbItems[parentId]);
            let childIndex = this.getIndex(childId, dbItems[childId]);
