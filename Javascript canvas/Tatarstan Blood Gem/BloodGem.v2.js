...
class ImageWidgetMouseSensor{
    onMouseDown(x, y, evt, widget) {
        ...
        //console.log('onMouseDown ctl:', evt.ctrlKey, widget);
    }
    
    onMouseDownOut(x, y, evt, widget){
        if (!evt.ctrlKey && !widget.multiSelect) {
            if (widget.selectorWidget) {
                this.unselectWidget(widget)
        ...
        //console.log('onMouseDownOut ctl:', evt.ctrlKey, widget);
    }
    ...
    mouseUp(x, y, evt, widget){
        if (widget.dragSelect || widget.multiSelect) {
            //widget.dragSelect = false;
        ...
        console.log('onMouseUp* ctl:', evt.ctrlKey, widget);
    }
    ...
    mouseMove(x, y, evt, widget){
        if (widget.dragSelect) {
            ...
            oldY = y;
            d.refresh = true;
            //console.log('onMouseMove* ctl:', evt.ctrlKey, widget);
        } else {
            if (widget.multiSelect) {
                widget.selectorWidget.move(deltaX, deltaY);
                d.refresh = true;
...
class ImageMouseSensor{
    ...
    mouseMove(x, y, evt, widget){
        ...
        for (let lowerWidget of widget.lowerWidgets){
            if (lowerWidget.multiSelect && !lowerWidget.dragSelect) {
                lowerWidget.selectorWidget.move(deltaX, deltaY);
                d.refresh = true;
            }
        }
